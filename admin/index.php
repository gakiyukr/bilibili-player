...
<head>
	...
	<link rel="stylesheet" type="text/css" href="https://cdn.bootcdn.net/ajax/libs/layui/2.6.4/css/layui.css" />
	<script type="text/javascript" src="https://cdn.bootcdn.net/ajax/libs/layui/2.6.4/layui.js" type="text/javascript" charset="utf-8"></script>
	<script src="https://cdn.bootcdn.net/ajax/libs/jquery/2.1.1/jquery.min.js" type="text/javascript" charset="utf-8"></script>
			...
			<div class="layui-tab-content">
				<div class="layui-tab-item layui-show" name="基本设置">
					...
					<div class="layui-form-item">
						...
						<div class="layui-form-mid layui-word-aux">仅进度条？颜色代码 例如：#00a1d6</div>
					</div>
					<div class="layui-form-item">
						...
						<div class="layui-form-mid layui-word-aux">图片地址 例如：/dplayer/logo.png</div>
					</div>
					<div class="layui-form-item">
					...
					<div class="layui-form-item">
						...
						<div class="layui-form-mid layui-word-aux">(秒)播放进度跳转等待</div>
					</div>
					<div class="layui-form-item">
						...
						<div class="layui-form-mid layui-word-aux">(秒)只能在设置时间后才能重新发送弹幕</div>
					</div>
					<div class="layui-form-item">
				...
				<div class="layui-tab-item" name="广告设置">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<select name="yzm[ads][set][group]" lay-verify="required">
								<option value="null" <?php $t = $yzm['ads']['set']['group'];if ($t == "null") echo "selected"; ?>>全部</option>
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-block">
							<input type="checkbox" name="yzm[ads][pause][state]" lay-skin="switch" lay-filter="switchTest" lay-text="ON|OFF" <?php $t = $yzm['ads']['pause']['state'];if ($t == "on") echo "checked"; ?>>
							<div class="layui-unselect layui-form-switch" lay-skin="_switch"><em>Off</em><i></i></div>
						</div>
					</div>
					<div class="layui-form-item">
